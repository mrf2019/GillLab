...
LowerRelABSPP_sort<-sort(Lower_Spp_RelAb, decreasing=T)
UpperRelABSPP_sort<-sort(Upper_Spp_RelAb, decreasing=T)
...
plot(LowerRelABSPP_sort, col= my_red, ylab="Relative Abundance",
     main="Relative Abundance by Order", names.arg=c("Araneida", "Coleoptera", "Collembola", "Diptera", "Lumbricidae", "Nematoda",
                                                   "Opiliones", "Polyxenida", "Polyzoniida", "Formicidae", "Acari",
                                                   "Chordeumida", "Hymenoptera", "Julida", "Neuroptera", "Gastropoda",
                                                   "Diplura", "Enchytraeidae", "Geophilomorpha", "Symphyla")) 
